...
c         = 0.001;                                  //Variable cost 0.1 percent
...
lambda = 0;                              //Lambda
alpha = 0.95;                            //Alpha
rebalanceAfter = 1;                      //After 1 months rebalance the portfolio
...
EXECUTE 'gdxxrw.exe ETFPortfolio_MC_UPdate.gdx O=1Results.xlsx par=SummaryReportAll rng=BOOT!a1' ;

//COMPOSITION OF THE PORTFOLIO IN EACH PERIOD
EXECUTE_UNLOAD 'ETFPortfolio_MC_UPdateComp.gdx', SummaryReport2;
EXECUTE 'gdxxrw.exe ETFPortfolio_MC_UPdateComp.gdx O=1Results.xlsx par=SummaryReport2 rng=BOOTcomp!a1' ;
