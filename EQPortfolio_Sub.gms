...
* Creates 1/N portfolio for given subset of ETFs
...
*Loading assets from "RollingScenarios.gdx"
$GDXIN RollingScenarios
$LOAD  Asset
$GDXIN

SET
         SubAsset(Asset) /URTH/     //MSCI Denamrk index
*Cluster 1: /AOA, IGE, IXC, VDE, IUSB, ISTB, VCSH, VT, VTI, XBI, FBT, PALL, PGX, ANGL, PGF, XMLV, IGV, IHI/
*Cluster 2: /VT, AOA, IUSB, IGV, IHI, XMLV, URTH, GLTR, DBP, GDX, BOND, AOK, SKYY, GLD, SGOL, IAU, SPLV, USMV/
...
$GDXIN RollingScenarios
$LOAD  Periods Scenarios ScenarioReturnP
$GDXIN

DISPLAY  SubAsset, Periods, Scenarios, ScenarioReturnP;
...
ExpectedReturnp("p0") = (ExpectedReturn.l-15*20)/Budget-1;
...
EXECUTE 'gdxxrw.exe EQPortfolio_Results.gdx O=1Results.xlsx par=SummaryReport rng=MSCI!a1';
